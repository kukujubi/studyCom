...
public class AlphaController {
    ...
    public String setCookie(HttpServletResponse response){
        ...
        //设置cookie生效的范围
        cookie.setPath("/community/alpha");//在这个路径和子路径下有效
        //cookie默认存在内存里 关掉就有效 如果设置了生存时间 就存在硬盘里
        cookie.setMaxAge(60*10);
        //发送cookie 放在response头里
    ...
    @ResponseBody
    public String getSession(HttpSession session){//SPRINGMVC对session是自动注入
