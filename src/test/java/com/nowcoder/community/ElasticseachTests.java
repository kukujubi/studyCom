...
public class ElasticseachTests {
    @Autowired
    ...
    public void testSearchByRepository(){
        ...
        //底层是调用了这个 elasticsearchTemplate.queryForPage(searchQuery,class,SearchResultMapper)
        //底层获取到了高亮显示的值，但是没有返回

        Page<DiscussPost> page=discussPostRepository.search(searchQuery);
        System.out.println(page.getTotalElements());//共多少条数据匹配
        System.out.println(page.getTotalPages());//一共有多少页
        System.out.println(page.getNumber());//当前处在第几页
        System.out.println(page.getSize());//每一页最多显示多少条数据
